...
const (
	MailerService_Send_FullMethodName = "/mailer.v2.MailerService/Send"
)
...
type MailerServiceClient interface {
	Send(ctx context.Context, in *MailEvent, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *mailerServiceClient) Send(ctx context.Context, in *MailEvent, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type MailerServiceServer interface {
	Send(context.Context, *MailEvent) (*emptypb.Empty, error)
...
func (UnimplementedMailerServiceServer) Send(context.Context, *MailEvent) (*emptypb.Empty, error) {
...
func _MailerService_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MailerServiceServer).Send(ctx, req.(*MailEvent))
	}
...
var MailerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mailer.v2.MailerService",
	...
	Metadata: "v2/mailer/mailer.proto",
}
